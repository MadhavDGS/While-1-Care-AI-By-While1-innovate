...
def get_chat_response(prompt):
    ...
    try:
        ...
        medical_prompt = f"""
        You are a WHile(1)CareAI medical AI assistant. Please provide helpful medical information and advice while keeping in mind:
...
def create_pdf_report(report_data, image=None):
    ...
    # Add letterhead
    story.append(Paragraph("While(1)CareAI Medical Center", title_style))
