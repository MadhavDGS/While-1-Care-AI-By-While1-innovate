...
def main():
    ...
    if menu == "Patient Records":
        ...
        if analysis_results:
            ...
            with col1:
                include_letterhead = st.checkbox("Include While(1)CareAI Letterhead", value=True)
            ...
            if st.button("Generate Report"):
                with st.spinner("Generating medical report..."):
                    ...
                    filename = f"While1CareAI_MedicalReport_{patient_name}_{date_str}.pdf"
...
def create_medical_report(analysis_data, doctor_name, report_date, include_letterhead=True, include_signature=True, recommendations=None):
    ...
    if include_letterhead:
        ...
        elements.append(Paragraph("While(1)CareAI Medical Center", title_style))
        ...
        Tel: +91-1234567890 | Email: care@while1careai.com<br/>
        www.while1careai.com
        </para>
        """
    ...
    While(1)CareAI employs state-of-the-art technology, but results should be validated by appropriate medical specialists.</i></para>
    """
